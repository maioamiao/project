        ...
        <div class="type-nav">
            <div class="container">
                <div @mouseenter="enterShow" @mouseleave="leaveShow">
                    <div @mouseleave="changeClass">
                        <h2 class="all">全部商品分类</h2>
                        <transition name="sort">
                            <div class="sort" v-show="show">
                            <div class="all-sort-list2" @click="goSearch">
                                <div class="item" v-for="(c1,index1) in categoryList" :key=c1.categoryId >
                                    <h3 @mouseenter="addClass(index1)"   :class="{bgColor:index1 == originNum}" >
